...
class IndexController extends HomeBaseController
{
    ...
    public function loadMore(){
        ...
        $offset = 5;
        $rows = 5;
        echo 'select * from cmf_portal_category_post,cmf_portal_post,cmf_user where cmf_portal_category_post.post_id=cmf_portal_post.id and cmf_user.id=cmf_portal_post.user_id and category_id=1 limit '.$offset+($page-1)*5.','.$rows;
